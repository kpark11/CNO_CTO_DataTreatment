# -*- coding: utf-8 -*-
"""
Created on Tue Apr  5 17:36:59 2022
...
file = r'C:\Users\Student\OneDrive - University of Tennessee\Desktop\Research\A4B2O9\CNO\reflectance\5.11.2021\ab-plane\After merging, renormalizing'
os.chdir(file)
cwd = os.getcwd()
print(cwd)
...
for k in range(len(list)):
    if fnmatch.fnmatch(list[k],'*.ALP_python*'):
        ...
        corrected_data = np_data[405:548,0]
        corrected_data = np.column_stack((corrected_data,np_data[405:548,1]))
